...
// Сюда попадает артефакт, который меняет результат уже выбранного действия:
// прибавку или множитель к его урону, шанс попадания, диапазон крита, тип урона,
// снятие своей слабости. Артефакт, который сам является источником урона
// (Посох волшебника, Амулет друида), — это способность, а не модификатор.
// Лечение, защита, перемещение и утилита не моделируются вовсе.
// Зелья и настойка из артефактов уже покрыты тумблерами rage/chaos/tincture.
